...
class TestAuthentication_continue_partial:
    @pytest.mark.sanity 
    def test_authentication_continue_partial(self, driver):
        ...
        # Clic on the button
        appium_driver.wait_for_element('//*[@name='authentificationSelection_continueAsGuest_button' and @type='XCUIElementTypeButton']')
        appium_driver.click_element_by_name("//*[@name='authentificationSelection_continueAsGuest_button' and @type='XCUIElementTypeButton']")
