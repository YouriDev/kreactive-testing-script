...
class TestProduct_partial:
    ...
    def test_product_partial(self, driver):
        ...
        # Clic on the button
        appium_driver.wait_for_element('//*[@name='pdp_mainBottomAction_button' and @type='XCUIElementTypeButton']')
        appium_driver.click_element_by_name("//*[@name='pdp_mainBottomAction_button' and @type='XCUIElementTypeButton']")
